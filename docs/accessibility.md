...
Right-clicking an email or web address offers to copy it. The address is found two ways, and a `/Link` annotation the author declared always wins over anything spotted in the printed text, because that is the target a click would actually follow.
