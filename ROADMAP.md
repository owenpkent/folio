...
| Page operations | Insert, delete, reorder, rotate, split, and merge pages | In progress (combining whole PDFs into one document is done; insert, delete, reorder, rotate, and split are planned) |
